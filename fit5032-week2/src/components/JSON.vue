...
<template>
  ...
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <p>George Orwell's works</p>
      <ul v-for="author in orwell" :key="author">
    ...
    <section class="lab-section">
      ...
      <!-- TODO: CODE TO RENDER LIST OF STORE TYPES HERE -->
       <ul>
        <li v-for="(item, index) in bookstores.storeTypes" :key="index">
          {{index}}: {{ item }}
        </li>
       </ul>
      ...
      <!-- TODO: CODE TO RENDER LIST OF OPENING HOURS HERE -->
       <ul>
        <li v-for="(item, index) in bookstores.openingHours" :key="index">
          {{ index }} :{{ item }}
        </li>
    ...
    <section class="lab-section">
      ...
      <ul v-for="author in authors" :key="author">
        <li v-if="author.name == George" :class="{binding: isActive}">
          {{ author.name }}
         </li>
         <li v-else>
          {{ author.name }}
